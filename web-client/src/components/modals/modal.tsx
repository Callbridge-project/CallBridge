...
const CustomModal: FC<CustomModalProps> = ({
  ...
  return (
    <NewModal
      ...
      radius={radius}
      classNames={{
        body: cn("py-0 dark:text-[#F5F5F5] overflow-y-auto scrollbar-hide", classNames.body),
        base: cn(
          "border-[#161616] dark:bg-sidebar dark:text-[#a8b0d3] font-header spacing-sm max-h-[calc(100vh-80px)]",
          classNames.base,
        ),
        ...
        backdrop: cn("bg-[#090d16]/45 backdrop-blur-sm ", classNames.backdrop),
      }}
      motionProps={{
        variants: {
          enter: {
