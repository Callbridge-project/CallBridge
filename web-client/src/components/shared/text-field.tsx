      ...
      <div className="relative">
        ...
        <input
          ...
          className={cn(
            ...
            "disabled:cursor-not-allowed disabled:opacity-50",
            "transition-all duration-200",
            // Dynamically adjust padding and text size if height is compact (e.g., h-10, h-9)
            height.includes("h-10") || height.includes("h-9") || height.includes("h-8") || height.includes("h-[2.")
              ? "py-2 text-[12px]"
              : height.includes("h-11")
              ? "py-2.5 text-sm"
              : "py-3 text-sm",
            height.replace("h-", "min-h-"),
            error && "border-red-400 focus:border-red-400 focus:ring-red-400",
