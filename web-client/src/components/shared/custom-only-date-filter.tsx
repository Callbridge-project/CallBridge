...
export const CustomOnlyDateFilterComponent = ({
  ...
  return (
    <div className="relative font-header">
      ...
      >
        <Calendar className="w-3.5 h-3.5 text-ash-text shrink-0" />
      ...
      {!dismissDatePopup && (
        <div
          ...
          } bg-white dark:bg-primary-gray z-50 border rounded mt-1 shadow-lg flex flex-col md:flex-row sm:max-w-sm md:max-w-none custom-calendar-container`}
        >
          {/* Left sidebar with shortcuts (Desktop) */}
          <div className="hidden md:block py-6 px-4 min-w-[140px] tracking-tighter border-r border-zinc-100/30 dark:border-zinc-800">
              ...
              <div className="-ml-4 text-ash-text font-[400]">
                <DayPicker
                  ...
                  classNames={{
                    ...
                    weekday: "text-ash-text/70 rounded-md w-9 font-normal text-[0.72rem] text-center dark:text-zinc-500",
                    week: "flex w-full mt-2 justify-center",
                    day: "w-9 h-9 text-center text-sm p-0 relative focus-within:relative focus-within:z-20",
                    day_button: "h-9 w-9 p-0 font-normal hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-md flex items-center justify-center aria-selected:opacity-100 transition-colors text-inherit bg-transparent duration-200",
                    // v8/compatibility layout
                    table: "w-full border-collapse space-y-1",
                    head_row: "flex justify-center",
                    head_cell: "text-ash-text/70 rounded-md w-9 font-normal text-[0.72rem] text-center dark:text-zinc-500",
                  ...
                  {Array.from({ length: 12 }, (_, i) => {
                    ...
                    return (
                      <button
                        ...
                        className="py-3 px-2 font-medium rounded-md hover:bg-[#e4eef084] dark:hover:bg-white/5 transition-colors text-sm "
                      >
