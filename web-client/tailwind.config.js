  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "user-card": "hsl(var(--user-card-bg))",
        "user-card-border": "hsl(var(--user-card-border))",
        "user-avatar": "hsl(var(--user-avatar-bg))",
        "user-avatar-text": "hsl(var(--user-avatar-text))",
        "logout-border": "hsl(var(--logout-btn-border))",
        "logout-text": "hsl(var(--logout-btn-text))",
        "dashboard-muted": "rgb(var(--dashboard-muted) / <alpha-value>)",
        "dashboard-text": "rgb(var(--dashboard-card-text) / <alpha-value>)",
        "dashboard-unread": "rgb(var(--dashboard-unread) / <alpha-value>)",
        "global-border": "rgb(var(--global-border) / <alpha-value>)",
        "dashboard-border": "rgb(var(--dashboard-border) / <alpha-value>)",
        white: "#FFFFFF",
        alabaster: "#fafafa",
        silk: "#E0E0E0",
        stone: "#757575",
      ...
      fontFamily: {
        ...
        serif: ["Liberation Serif", "RecklessNeue", "Cormorant", "serif"],
        "secondary-sans": ["Liberation Sans", "sans-serif"],
